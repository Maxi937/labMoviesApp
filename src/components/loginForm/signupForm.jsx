      ...
      <form sx={styles.form} onSubmit={handleSubmit(onSubmit)} noValidate>
        <Controller
          ...
          render={({ field: { onChange, value } }) => (
            <TextField variant="outlined" margin="normal" required onChange={onChange} value={value} id="firstName" label="First Name" />
          )}
        />
        {errors.email && (
        ...
        <Controller
          ...
          defaultValue=""
          render={({ field: { onChange, value } }) => (
            <TextField variant="outlined" margin="normal" required onChange={onChange} value={value} id="lastName" label="Last Name" />
          )}
        />
        {errors.email && (
          <Typography variant="h6" component="p">
        ...
        <Controller
          ...
          defaultValue=""
          render={({ field: { onChange, value } }) => (
            <TextField variant="outlined" margin="normal" required onChange={onChange} value={value} id="password" label="Password" />
          )}
        />
        {errors.password && (
          <Typography variant="h6" component="p">
